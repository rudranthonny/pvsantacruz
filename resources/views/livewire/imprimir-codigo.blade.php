    ...
    <div>
        ...
        <div class="row my-2">
            <div class="col-12">
                ...
                <button class="btn btn-secondary" wire:loading.attr="disabled" wire:target="descargar_codigo_barrar_imprimir" wire:click='descargar_codigo_barrar_imprimir'><i class="fas fa-print"></i> Impresión</button>
            </div>
        </div>
