...
<body>
    ...
    <table>
        <tbody>
            <tr>
                <td>
                    <b>Fecha :</b> {{$devolucion->created_at}}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                   <b> Cliente :</b> {{$devolucion->cliente_name }}
                </td>
            </tr>
            <tr>
                <td>
                    <b> Almacen :</b> {{$devolucion->almacen_name }}
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table" width="100%">
        <tbody>
            @foreach ($devolucion->devoluciondetalles as $detalle)
                <tr>
    ...
    <table class="table" width="100%">
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center">{{number_format($devolucion->cantidad_recibida,2)}}</td>
                <td style="text-align: right">{{number_format($devolucion->cambio,2)}}</td>
            </tr>
        </tbody>
    </table>
    <br>
    <center>
    <span style="text-align: center;"><b>Gracias Por Su Devolución, Vuelva Pronto.</b></span><br>
    <span style="text-align: center;"><b>SL_{{$devolucion->id}}</b></span><br>
    <table width='100%'>
        <tr>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td>{!! DNS1D::getBarcodeHTML("RT_".$devolucion->id,'C128') !!}</td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </tr>
    </table>
    </center>
