                ...
                <form wire:submit="guardar" id="formularioProducto">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            ...
                            <select class="form-control" id="categoria" wire:model="productoForm.categoria_id">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            ...
                            <input type="text" class="form-control" id="marca" placeholder="Ingrese Marca"
                                wire:model="productoForm.marca">
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <label for="unidad" class="form-label">Unidad</label>
                            <input type="text" class="form-control" id="unidad" placeholder="Ingrese Unidad"
                                wire:model="productoForm.unidad">
                        </div>
                    </div>
                    <div class="row mb-3">
