...
class Pos extends Component
{
    ...
    public function guardarPosVenta()
    {
        ...
        if ($almacen) {
            ...
            $nombre_archivo = 'comprobante-' . date("F j, Y, g:i a") . '.pdf';
            $consultapdf = FacadePdf::loadView('administrador.pdf.comprobante', compact('posventa', 'configuracion'))->setPaper([0, 0, 215.25, $paper_heigth + 18.2 * 2 * (count($this->items)+1)]);
